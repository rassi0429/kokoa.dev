    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Accent bars */}
          <div
            style={{ position: 'absolute', top: '8%', right: '5%', width: 2, height: 80, background: 'var(--accent)' }}
          />
          <div
            style={{ position: 'absolute', top: '8%', right: '5%', width: 40, height: 2, background: 'var(--accent)' }}
          />
          <div
            style={{
              position: 'absolute',
          ...
          >
            ...
            >
              ...
              <img
                className="hero-avatar-image"
                src={avatarMaid}
                alt="KOKOA work outfit maid avatar"
                style={{
                  backfaceVisibility: 'hidden',
                  WebkitBackfaceVisibility: 'hidden',
...
function Arrow() {
  return (
    <svg width="14" height="10" viewBox="0 0 14 10" fill="none">
      <path d="M1 5h12m0 0L9 1m4 4L9 9" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
    ...
    return (
      <div
        style={{
          ...
          opacity: 0.4,
          background:
            "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200'><filter id='n'><feTurbulence baseFrequency='0.9'/></filter><rect width='200' height='200' filter='url(%23n)' opacity='0.3'/></svg>\")",
        }}
      />
    );
  return null;
