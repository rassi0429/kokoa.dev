...
function About({ tweaks }) {
  ...
  return (
    <section id="about" data-screen-label="02 About" style={{padding:'120px 6vw', position:'relative'}}>
      <SectionHeader num="02" title="About" subtitle={L?"Who I am":"自己紹介"}/>
      <div style={{maxWidth:1280, margin:'40px auto 0', display:'grid', gridTemplateColumns:'1.2fr 1fr', gap:32}}>
        {/* Terminal panel */}
        <div style={{
          border:'1px solid rgba(255,255,255,0.1)',
          background:'rgba(8,9,13,0.6)', borderRadius:8,
          fontFamily:'"JetBrains Mono", monospace',
          overflow:'hidden',
        }}>
          <div style={{
